...
var engine = function(spec, my) {
  ...
  user_get = function(user, cb) {
    ...
    var done = function(u) {
      /* DaTtSs */ my.dts.srv.agg('engine.user_get', (Date.now() - now) + 'ms');
      /* DaTtSs */ my.dts.srv.agg('engine.user_get', '1c');
      cb(null, u);
    };
  ...
  agg = function(user, data) {
    ...
    var done = function(p) {
      ...
      //console.log('--------------------------------------------');
      /* DaTtSs */ my.dts.srv.agg('engine.agg', (Date.now() - now) + 'ms');
      /* DaTtSs */ my.dts.srv.agg('engine.agg', '1c');
    };
  ...
  current = function(user, cb) {
    ...
    user_get(user, function(err, u) {
      if(err) {
        ...
        /* DaTtSs */ my.dts.srv.agg('engine.current', (Date.now() - now) + 'ms');
        /* DaTtSs */ my.dts.srv.agg('engine.current', '1c');
  ...
  var stat = function(user, process, type, name, cb) {
    ...
    stat.load(function(err) {
      if(err) {
        ...
        /* DaTtSs */ my.dts.srv.agg('engine.stat', (Date.now() - now) + 'ms');
        /* DaTtSs */ my.dts.srv.agg('engine.stat', '1c');
